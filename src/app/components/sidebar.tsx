    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b border-brand-black dark:border-white/10">
          ...
          <button
            onClick={onClose}
            className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-foreground/20 hover:bg-muted transition-colors"
            ...
            {groups.map((g) => (
              <div key={g.key} className="mb-4">
                <button
                  ...
                  className="w-full flex items-center justify-between py-1.5 text-[10px] font-bold text-muted-foreground uppercase tracking-[0.12em] hover:text-foreground transition-colors"
                >
                  {g.label}
                  <svg
              ...
              <div className="space-y-1">
                {recentMonths.map((m) => (
                  <Link
                    ...
                    href={`/report/${m}`}
                    onClick={onClose}
                    className="flex items-center gap-2 px-3 py-2 rounded-md text-sm text-foreground/75 hover:bg-muted hover:text-foreground transition-colors"
                  >
